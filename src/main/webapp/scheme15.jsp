	...
	<b><h2 class="w3-text-orange" style="text-shadow:2px 2px 0 #444">${MESSAGE}</h2></b>
			...
			<div class="pic w3-animate-top">
				...
				<div class="w3-container w3-center">
					<img src = "pics/15.png" width="300" height="150" class="w3-padding">
				</div>
			</div>
<div  class="flex-container">	
	<div class="w3-col m6 l4 s12 w3-animate-left">
		<form action="Calculation13_18" method="GET" class="w3-container">
		  ...
		  <input type="hidden" name="command" value="SCHEME15" />
		  <p>
		  ...
		  <input type="submit" value="Рассчитать"/></p>
		  	<br>			
				<h4 class="w3-text-orange" style="text-shadow:2px 2px 0 #444">Касательное напряжение, МПа : ${RESULT} </h4>
				<br>
